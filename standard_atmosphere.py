...
def atmosphere(alt):
    ...
    Adapted from https://www.pdas.com/atmos.html
    Input:
    ...
    PSEA = 101325;      # pressure at sea level (Pa)
    TSEA = 288.15;      # temperature at sea level (K)
    ...
    # Convert from normalized values to SI units
    p = delta*PSEA
    T = theta*TSEA
    rho = sigma*RHOSEA
    return ( p, T, rho )
